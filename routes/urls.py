...
urlpatterns = [
  ...
  #
  path("stops/", views.StationsView.as_view(), name="stops"),
  path("stops/new", views.CreateStationView.as_view(), name="create_stop"),
  path("stops/<pk>/update/", views.UpdateStationView.as_view(), name="update_stop"),
  path("stops/<pk>/delete/", views.DeleteStationView.as_view(), name="delete_stop")
]
